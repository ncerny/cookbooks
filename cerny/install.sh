...
parted /dev/$1 mkpart ESP fat32 1MiB 551MiB
parted /dev/$1 set 1 esp on
parted /dev/$1 mkpart primary linux-swap 551MiB 4.5GiB
parted /dev/$1 mkpart primary ext3 4.5GiB 100%
parted /dev/$1 set 3 boot on
...
tar -xvzf hab.tgz -C /mnt/usr/local/bin --strip-compontents 1
